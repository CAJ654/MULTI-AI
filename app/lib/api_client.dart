...
// Attachment/AttachmentKind/ChatTurn moved to chat_types.dart so the on-device
// engine can be imported without Flutter (see that file). Imported for use
// below, and re-exported so importing api_client.dart still brings them in, as
