...
#define __pyx_n_u_version __pyx_string_tab[11]
...
*/
  {
    PyObject* __pyx_temp[1] = {__pyx_mstate_global->__pyx_n_u_version};
    __pyx_t_2 = __Pyx_PyList_FromArray(__pyx_temp, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{5},{1},{17},{0},{7},{8},{10},{8},{12},{8},{11},{6},{18},{6},{10}};
    /* compression: none (128 bytes) */
static const char bytes[] = ".0.1.0?multi_ai.__init____all____main____module____name____qualname____test____version__appendcline_in_tracebackmodelssetdefault";
    PyObject *data = NULL;
