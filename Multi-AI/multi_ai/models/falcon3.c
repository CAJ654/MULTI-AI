...
static const char __pyx_k_Falcon3_3B_TII_s_efficient_Falco[] = "Falcon3 3B: TII\047s efficient Falcon 3 series, sized for single-GPU/edge use.";
/* #### Code section: decls ### */
...
#define __pyx_n_u_multi_ai_models_falcon3 __pyx_string_tab[27]
