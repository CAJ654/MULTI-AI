...
static const char __pyx_k_Gemma_2_2B_Google_s_second_gener[] = "Gemma 2 2B: Google\047s second-generation Gemma release.";
/* #### Code section: decls ### */
...
#define __pyx_n_u_multi_ai_models_gemma2 __pyx_string_tab[27]
