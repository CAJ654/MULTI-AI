...
#define __pyx_n_u_TensorFlow __pyx_string_tab[3]
...
#define __pyx_n_u_name_2 __pyx_string_tab[9]
#define __pyx_n_u_qualname __pyx_string_tab[10]
#define __pyx_n_u_test __pyx_string_tab[11]
#define __pyx_n_u_version_2 __pyx_string_tab[12]
...
#define __pyx_n_u_multi_ai_models_TensorFlow __pyx_string_tab[18]
...
#define __pyx_n_u_tensorflow __pyx_string_tab[22]
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_CompareBoolEq_object_str(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_main, Py_EQ); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } str_length_index[] = {{5},{1},{39},{10},{20},{12},{8},{8},{10},{8},{12},{8},{11},{13},{18},{18},{8},{5},{26},{4},{5},{10},{10},{2},{6},{7}};
    const struct { const unsigned int length: 4; } bytes_length_index[] = {{13}};
    /* compression: none (297 bytes) */
static const char bytes[] = "0.1.0?Multi-AI/multi_ai/models/TensorFlow.pyxTensorFlow__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test____version___is_coroutineasyncio.coroutinescline_in_tracebackget_infoitemsmulti_ai.models.TensorFlownameprintsetdefaulttensorflowtfvaluesversion\200\001\330\004\014\210H\220N\240+\250Q";
    PyObject *data = NULL;
