...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{24},{8},{10},{8},{12},{8},{18},{10}};
    /* compression: none (99 bytes) */
static const char bytes[] = "?multi_ai.models.__init____main____module____name____qualname____test__cline_in_tracebacksetdefault";
    PyObject *data = NULL;
