...
static const char __pyx_k_GLM_5_2_Zhipu_Z_ai_s_744B_MoE_mo[] = "GLM-5.2: Zhipu/Z.ai\047s 744B MoE model, run via a Colibri server this app\nstarts and supervises itself.\n\nDoesn\047t fit either existing path: transformers/torch can\047t hold a 744B\ncheckpoint (_REPO_ID), and llama.cpp/llamadart has no engine for GLM-5.2\047s\narchitecture (_GGUF_SOURCE). Colibri (https://github.com/JustVugg/colibri)\nruns it on consumer hardware by streaming individual MoE experts from disk\ninstead of residing the whole model in RAM. GLM-5.2\047s raw checkpoint needs a\none-time int4 conversion Colibri doesn\047t do automatically, so\n_COLIBRI_REPO_ID points at a pre-converted community mirror\n(jlnsrk/GLM-5.2-colibri-int4) rather than zai-org\047s own repo \342\200\224 server.pyx\ndownloads it via the normal cache/download routes, then spawns\n`coli serve --model <path> --port 8010` itself on first chat. The `coli`\nbinary itself is still a one-time manual install (see README).\n";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_744B_40_55B_active __pyx_string_tab[1]
...
#define __pyx_n_u_COLIBRI_REPO_ID __pyx_string_tab[10]
#define __pyx_n_u_EXTERNAL_ENDPOINT __pyx_string_tab[11]
#define __pyx_n_u_EXTERNAL_ENDPOINT_PORT __pyx_string_tab[12]
#define __pyx_n_u_EXTERNAL_MIN_RAM_GB __pyx_string_tab[13]
#define __pyx_n_u_EXTERNAL_RECOMMENDED_RAM_GB __pyx_string_tab[14]
...
#define __pyx_n_u_colibri __pyx_string_tab[26]
#define __pyx_n_u_context_tokens __pyx_string_tab[27]
#define __pyx_n_u_get_info __pyx_string_tab[28]
...
#define __pyx_n_u_multi_ai_models_glm_5_2_colibri __pyx_string_tab[32]
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_CompareBoolEq_object_str(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_main, Py_EQ); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 9; } str_length_index[] = {{5},{21},{1},{261},{43},{21},{44},{116},{27},{4},{16},{18},{23},{20},{28},{20},{12},{8},{8},{10},{8},{12},{8},{13},{18},{18},{7},{14},{8},{5},{7},{8},{31},{4},{6},{5},{7},{10},{7},{13},{9},{6},{7}};
    const struct { const unsigned int length: 6; } bytes_length_index[] = {{57}};
    #ifndef CYTHON_COMPRESS_STRINGS
      #define CYTHON_COMPRESS_STRINGS 0
    #endif
    #if (CYTHON_COMPRESS_STRINGS) == 1 /* compression: zlib (644 bytes) */
static const char cstring[] = "x\332mS\315n\332@\020n\244V\242\267\376^r\232\236\nRl\022\n\312\261\202\200\020R\014\324\242Ro\253\215=6[\354]\327;&\320C\224G\340\320C\036\215s\237\240\217\320\261c\322\264\252%\357\354\316\316\337\367\315\354\251{\346\236\236w\273\003h\336tO\235^o\0002 \265\306\326\307>TzOm\250\310\3211\2213\332d\230\223\205\324\204\230@^h\240en\212x\t\027&QW\271zo!Tv\345X\312Q\246\030\002V\036\220\030\031*\035\303\317\333\037\020\345F\223\302\