...
#define __pyx_kp_u_Llama_3_2_3B_model_stub __pyx_string_tab[1]
 ...
 * print("Llama 3.2 (3B) model stub")             # <<<<<<<<<<<<<<
*/
  if (__Pyx_PrintOne(0, __pyx_mstate_global->__pyx_kp_u_Llama_3_2_3B_model_stub) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{25},{18},{3},{4},{8},{10},{8},{5},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (98 bytes) */
const char* const cstring = "x\332%\212A\016\200 \014\004\277\302Q/\036\344\001&\236\375CS\240$\304R\025\312\377\255q\017\273\231\311n\007cE\347\227\325M~\237]\275\022\261\353:B\344\"\004E@\033F\n\030O\222\224\013\023@E\323\026;\217\217\001\004\253\355\335\212(\3003\220\177\321I\023e\034lV\251[\277\343\205*\220";
...
const char* const bytes = "?Llama 3.2 (3B) model stubcline_in_tracebackendfile__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;
