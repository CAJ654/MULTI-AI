...
static const char __pyx_k_Llama_3_2_3B_Instruct_Meta_s_Lla[] = "Llama 3.2 3B Instruct: Meta\047s Llama 3.2 at the 3B size.";
/* #### Code section: decls ### */
...
#define __pyx_n_u_multi_ai_models_llama_3_2_3b __pyx_string_tab[27]
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } str_length_index[] = {{5},{2},{1},{98},{30},{21},{32},{41},{29},{4},{8},{20},{12},{8},{8},{10},{8},{12},{8},{13},{18},{18},{14},{8},{5},{7},{8},{28},{4},{6},{5},{7},{10},{7},{13},{9},{6},{7}};
    const struct { const unsigned int length: 6; } bytes_length_index[] = {{55}};
    /* compression: none (605 bytes) */
static const char bytes[] = "0.1.03B?Compact Llama 3.2 tuned for edge/on-device deployment \342\200\224 good instruction-following for its size.Fast, good intelligence for 3BLlama 3.2 3B InstructMeta Llama 3.2 Community LicenseMulti-AI/multi_ai/models/llama_3_2_3b.pyxunsloth/Llama-3.2-3B-InstructText_REPO_ID__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutineasyncio.coroutinescline_in_tracebackcontext_tokensget_infoitemslicensemodalitymulti_ai.models.llama_3_2_3bnameparamsprintrepo_idsetdefaultsize_gbspeed_profilestrengthsvaluesversion\200\001\330\004\005\330\010\020\220\001\330\010\023\2201\330\010\023\2201\330\010\022\220!\330\010\023\2201\330\010\024\220A\330\010\032\230!\330\010\023\2201\330\010\025\220Q\340\010\031\230\021";
    PyObject *data = NULL;
