...
#define __pyx_kp_u_Gemma_3n_model_stub __pyx_string_tab[1]
 ...
 * print("Gemma-3n model stub")             # <<<<<<<<<<<<<<
*/
  if (__Pyx_PrintOne(0, __pyx_mstate_global->__pyx_kp_u_Gemma_3n_model_stub) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
const char* const cstring = "x\332%\212\301\r\2000\014\003Wa\001^\014\300\2231\242\264u\245\212$@\233\356O\020~\330\272\223\367\003\252\274n\266\350U \313\360\231\2624\0035#\357\234\2218\237\260R\233\200H9t$\316\363c\"c\215\275{3'z&\313/\006\274\240\362\224\260\216\021\375\002\203N)\305";
...
const char* const bytes = "?Gemma-3n model stubcline_in_tracebackendfile__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;
