...
static const char __pyx_k_Llama_3_2_3B_Instruct_Meta_s_Lla[] = "Llama 3.2 3B Instruct: Meta\047s Llama 3.2 release.";
/* #### Code section: decls ### */
...
#define __pyx_n_u_multi_ai_models_llama3_2 __pyx_string_tab[27]
